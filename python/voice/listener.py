...
//.\.venv\Scripts\python.exe -c "from voice.listener import MicrophoneListener; listener = MicrophoneListener(); listener.start_recording(); listener.start_recording(); print('Still recording:', listener.is_recording); listener.cancel_recording(); print('Finished normally')"
